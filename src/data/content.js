...
import { SearchCheck, Eye, ScanSearch, Facebook, Wrench, LayoutTemplate, LineChart, BarChartBig, Award, GraduationCap, Briefcase, CalendarDays, Mail, Phone, MapPin } from 'lucide-react';
...
export const EDUCATION = [
  {
    ...
    institution: "Institute of Science and Technology (IOST; TU), Texas International College",
    year: "August 2024",
...
export const CERTIFICATIONS = [
  { name: "The Fundamentals of Digital Marketing", issuer: "Google Digital Garage", icon: Award },
  { name: "SEMRush Certified SEO", issuer: "SEMRush", icon: Award }
];

export const SKILLS_TOOLS = [
  { name: "SEM Rush & Ahrefs", icon: SearchCheck, description: "Comprehensive SEO, keyword research, and competitor analysis." },
  { name: "Google Analytics (GA4)", icon: BarChartBig, description: "Web analytics, user behavior tracking, and reporting." },
  { name: "Google Search Console", icon: LineChart, description: "Website performance monitoring and issue diagnosis in Google Search." },
  { name: "WordPress CMS", icon: LayoutTemplate, description: "Content management, website publishing, and blog handling." },
  { name: "Rank Math & Yoast SEO", icon: Wrench, description: "WordPress SEO plugins for on-page optimization." },
  { name: "Microsoft Clarity", icon: Eye, description: "User behavior analytics with heatmaps and session recordings." },
  { name: "Screaming Frog", icon: ScanSearch, description: "SEO site auditing and technical issue identification." },
  { name: "Meta Business Suite", icon: Facebook, description: "Social media marketing, advertising, and page management on Meta platforms." },
];
...
const experiencesData = [
  ...
  },
  {
    ...
    imageUrl: 'https://source.unsplash.com/random/600x400?writing,script,computer',
    dataAiHint: 'writing script computer',
    company: 'Freelance',
    description: 'Part-time freelance Content Writer & YouTube SEO, specializing in writing engaging YouTube video scripts for various channels.',
    details: 'Working as a part-time freelance Content Writer & YouTube SEO.\nWriting YouTube video scripts for upcoming channels on a contractual basis.',
  ...
  },
  {
    ...
    tags: ['Project Management', 'Client Interaction', 'Documentation', 'Agile'],
    imageUrl: 'https://source.unsplash.com/random/600x400?team,meeting,project',
    dataAiHint: 'team meeting project',
    company: 'Buddha Tech',
    description: 'Gained foundational experience in project management, including client communication, meeting facilitation, and detailed documentation.',
    details: 'Became a project manager trainee for “Buddha Tech” for two months.\nPerformed various tasks such as client interactions, minute-taking, and detail collection, along with a strong focus on documentation.',
    client: 'Buddha Tech',
...
export const CONTACT_DETAILS_ITEMS = [
    { icon: Mail, text: PERSONAL_INFO.contactEmail, href: `mailto:${PERSONAL_INFO.contactEmail}` },
    { icon: Phone, text: PERSONAL_INFO.phone, href: `tel:${PERSONAL_INFO.phone}` },
    { icon: MapPin, text: PERSONAL_INFO.location, href: `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(PERSONAL_INFO.location)}` },
];
